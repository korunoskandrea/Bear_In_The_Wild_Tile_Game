...
public class TiledSystem extends EntitySystem {
    ...
    private MapLayer collideObjectsLayerRiver;
    ...
    private void init() {
        ...
        collideTileLayer = (TiledMapTileLayer) tiledMap.getLayers().get("l_apple");
        collideObjectsLayer = tiledMap.getLayers().get("l_object");
        collideObjectsLayerRiver = tiledMap.getLayers().get("l_object_river");
    ...
    private void addRiverObstacle(MapLayer layer, Engine engine) {
        MapObjects objects = layer.getObjects();
        for (MapObject object : objects) {
            Rectangle rectangle = ((RectangleMapObject) object).getRectangle();
            Entity entity = engine.createEntity();
            BoundsComponent bc = engine.createComponent(BoundsComponent.class);
            bc.rectangle.set(rectangle);
            ObstacleComponentRiver ocr = engine.createComponent(ObstacleComponentRiver.class);
            entity.add(bc).add(ocr);
            engine.addEntity(entity);
        }
    }
    ...
    public void addedToEngine(Engine engine) {
        ...
        addRiverObstacle(collideObjectsLayerRiver,engine);
